...
def test_Update():
    ...
    fluid_cooler._provideResourceToOutgoingConnections = MagicMock(return_value = 10)
    fluid_cooler.update()

    # It's going to provide the 20 water, since that is it's max
    fluid_cooler._provideResourceToOutgoingConnections.assert_called_once_with("water", 20)
